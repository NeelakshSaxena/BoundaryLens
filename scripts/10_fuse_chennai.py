...
def main():
    ...
    bldgs_path = os.path.join("data", "processed", "chennai_buildings_ai_analyzed.geojson")
    ledger_path = os.path.join("data", "processed", "chennai_evidence_fusion_ledger.json")
    out_bldgs_path = os.path.join("data", "processed", "chennai_buildings_fused_final.geojson")
    frontend_path = os.path.join("frontend_chennai", "data", "buildings_3d.geojson")
    report_path = os.path.join("docs", "CHENNAI_EVIDENCE_FUSION_REPORT.md")
