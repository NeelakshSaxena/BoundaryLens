...
def main():
    ...
    out_path = os.path.join("data", "processed", "chennai_buildings_ai_analyzed.geojson")
    frontend_path = os.path.join("frontend_chennai", "data", "buildings_3d.geojson")
    report_path = os.path.join("docs", "CHENNAI_AI_ANOMALY_REPORT.md")
